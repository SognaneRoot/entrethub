              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    active ? 'text-app' : 'text-app-muted hover:text-app-2'
                  )}
                  style={active
                    ? { backgroundColor: 'var(--teal-soft)', color: 'var(--teal)' }
                    : {}
                  }
                >
                  <Icon className="w-4 h-4 shrink-0" style={active ? { color: 'var(--teal)' } : {}} />
