...
const DIFFICULTY_INSTRUCTIONS: Record<string, string> = {
  easy: 'Poses des questions simples et encourageantes.',
  medium: 'Poses des questions intermédiaires avec quelques cas pratiques.',
  hard: 'Poses des questions difficiles, challenges les réponses.',
  expert: 'Niveau FAANG. Questions très techniques et exigeantes.',
};
